...
For my initial redesign, I decided to focus on increasing the perceptibility of the visualization, so that readers can more easily and quickly make comparisons between the prevalence rates of modern slavery in different countries. I also wanted to try to improve the visualization’s completeness and truthfulness, by only including information that supports a prevalence-focused story, and information that comes from the data itself. I thought it could be exciting to create a visualization, such as a dot plot or bar chart, that allows readers to visually compare the gaps between these countries. I could also easily improve other areas of concern I identified, such as creating a title, and ensuring the colors I choose are intuitive. 
...
I kept the title as the largest text, bolded, and black to draw the viewer’s eyes immediately to it. I did change the name of the title to highlight that these gaps are so large (which is what I want viewers to notice) and I included the fact that this visualization shows the countries with the most and least prevalence, to address a point of confusion from the critique. I also created a subtitle, with less visual weight (it isn’t bold, had a lighter font shade, and a smaller font size), to address a peer’s concern that it wasn’t clear enough that the data shows estimates rather than actual values. I kept the x-axis label bold and black (though much smaller than the title) to maintain clarity for the viewers about what is being measured. I did decide, however, to remove the y-axis label of "Country" because it was drawing unnecessary attention; viewers would clearly be able to tell that the y-axis is countries because the country names speak for themselves. I also felt that removing it from the upper portion of my visualization gave the new subtitle more room to "breathe" and be seen by the viewer. The country names had slightly less visual weight than the x-axis label, but were still dark enough to be clearly understood. I also decided not to have the numerical labels next to the bars, because it made the visualization look busier than I wanted. The main point of the story is not necessarily the exact estimate of the prevalence, but rather the gaps between the countries. I incorporated a short definition of modern slavery, taken directly from Walk Free, to address another point of confusion from the critique. I did not give this definition much visual weight, though, keeping the text small and light. I included it right above the data source (which was given even less weight by being grey) because this is where the definition came from, as well.
